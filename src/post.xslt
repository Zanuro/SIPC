...
xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
   ...
   <nav class="navbar navbar-expand-lg navbar-ligth fixed-top">
     <a class = "imag" href="index.asp"/><img src="https://bit.ly/2qBuz2X" style="width:55px;height:40px;border-radius:10px;" alt="logo"/>
     ...
     <li class="nav-item"><a class="nav-link" href="aprender">Learn</a></li>
     <li class="nav-item"><a class="nav-link" href="retos">Challenges</a></li>
     <li class="nav-item"><a class="nav-link" href="forum.html">Forum</a></li>
     <li class="nav-item"><a class="nav-link" href="ranking">Ranking</a></li>
     <li class="nav-item"><a class="nav-link" href="about">About</a></li>
   </ul>
   <form class="form inline my-2">
      <input class="form-control mr-sm-1" type="search" placeholder="Busqueda" aria-label="Search"/>
      <button class="btn btn-outline-success" type="submit">Buscar</button>
        <a href="#container"><button class="btn btn-outline-success" type="button">Registrarse</button></a>
           <div id="container">
             <div class="popup">
               <a href="#">
             ...
             <div class="panel">
               ...
               <div class="usuario">
                 ...
                 <input type="text" requieredplaceholder="usuario@email.com" name="email" id="campo_correo"/>
                 </div>
               <div class="panell">

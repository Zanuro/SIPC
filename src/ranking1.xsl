      ...
      <body>
        <div class="body-main">
          <div class="body-center">
            ...
            <table id="tabla-ranking" class="table table-bordered">
              <thead>
                <tr>
                  <th>Username</th>
                  <th>Country</th>
              ...
              <tbody>
              <xsl:for-each select="Usuarios/USER">
                <xsl:sort select="COUNTRY"/>
                <xsl:choose>

                  <xsl:when test="XOR_POINTS &lt; 300 and XOR_POINTS &gt; 100">
                    <tr>
                      <td><xsl:value-of select="concat('Sys ',USER_NAME)"/></td>
                      <td><xsl:value-of select="COUNTRY"/></td>
                      <td><xsl:value-of select="XOR_POINTS"/></td>
                      <td><xsl:value-of select="EMAIL"/></td>
                      <td><xsl:value-of select="CHALLENGES"/></td>
                      <td><xsl:value-of select="CHAPTERS"/></td>
                      <td><xsl:value-of select="LAST_SEEN"/></td>
                      <xsl:variable name="x" select="XOR_POINTS"/>
                      <xsl:variable name="y" select="CHALLENGES"/>
                      <xsl:variable name="z" select="CHAPTERS"/>
                      <td><xsl:value-of select="($x*$y)+$z"/></td>
                    </tr>
                  </xsl:when>
                  <xsl:when test="XOR_POINTS &gt; 300">
                    <tr>
                      <td><xsl:value-of select="concat('Master ',USER_NAME)"/></td>
                      <td><xsl:value-of select="COUNTRY"/></td>
                      <td><xsl:value-of select="XOR_POINTS"/></td>
                      <td><xsl:value-of select="EMAIL"/></td>
                      <td><xsl:value-of select="CHALLENGES"/></td>
                  ...
                  <xsl:otherwise>
                    <tr>
                      <td><xsl:value-of select="concat('Starter ',USER_NAME)"/></td>
                      <td><xsl:value-of select="COUNTRY"/></td>
                      <td><xsl:value-of select="XOR_POINTS"/></td>
                      <td><xsl:value-of select="EMAIL"/></td>
                      <td><xsl:value-of select="CHALLENGES"/></td>
